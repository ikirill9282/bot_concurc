...
async def handle_start(
    ...
    parts = [
        ...
        "3) Отправьте другу вашу личную ссылку и попросите подписаться на канал.",
        "4) Как только друг подпишется, вы получите уведомление и станете участником розыгрыша.",
    ]
